...
.online::before {content: "•"; color: green;
  display: inline-block; width: 1em;
  margin-left: -1em}
.notonline::before {content: "•"; color: red;
  display: inline-block; width: 1em;
  margin-left: -1em}
			...
			<div class="widget-container fluid-height clearfix">
				<div class="widget-content padded clearfix">
					<ul class="nav nav-tabs">
						...
						<li><a data-toggle="tab" href="#edit">Edition du test</a></li>
					</ul>
								...
								<div class="col-md-4" id="add">
									<div class="widget-container fluid-height clearfix">
										...
										<div class="widget-content padded clearfix">
											...
											<a href="//<?= Url::connect("test_stop", $test->id_test, Text::slug($test->titre_test)); ?>" class="btn btn-danger pull-right">Stopper le test</a>
										</div>
									</div>
								</div>
								<div class="col-md-8">
						...
						<div id="live" class="tab-pane fade in active">
							<div class="row">
								<div class="col-md-6">
									<div class="widget-container fluid-height clearfix">
										<div class="heading">
											<i class="fa fa-shield"></i>Historique
										</div>
										<div class="widget-content padded clearfix">
											<ul id="history-qcm">
								...
								<div class="col-md-6">
									<div class="widget-container fluid-height clearfix">
										<div class="heading">
											<i class="fa fa-shield"></i>Liste des questions
										</div>
										<div class="widget-content padded clearfix" id="list-qcm-live">
											<div id="result_qcm"></div>
											<div id="listlqcmlive"></div>
										</div>
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-md-6">
									<div class="widget-container fluid-height clearfix">
										<div class="heading">
											<i class="fa fa-shield"></i>Question selectionnée
										</div>
										<div class="widget-content padded clearfix">
											<div id="selectedQuestion">Aucune question selectionnée</div>
										</div>
									</div>
								</div>
								<div class="col-md-6">
									<div class="widget-container fluid-height clearfix">
										<div class="heading">
											<i class="fa fa-shield"></i>Etudiant en ligne
										</div>
										<div class="widget-content padded clearfix">
											<ul id="onlines"></ul>
										</div>
...
var AJAX_TEST_START_QUESTION = "//<?= Url::connect("ajax_test_start_question");?>";
var AJAX_TEST_STOP_QUESTION = "//<?= Url::connect("ajax_test_stop_question");?>";
var AJAX_TEST_LIVE_STATS = "//<?= Url::connect("ajax_test_live_stats", $test->id_test);?>";

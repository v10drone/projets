	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100 p-t-85 p-b-20">
				<form class="login100-form validate-form ajax-form" data-url="//<?php echo Url::connect("ajax_register");?>" method="post">
					...
					<div class="wrap-input100 validate-input m-b-35" data-validate = "Champs requis">
						...
						<span class="focus-input100" data-placeholder="Votre prénom"></span>
					</div>
					...
					<div class="wrap-input100 validate-input m-b-35" data-validate = "Champs requis">
						...
						<span class="focus-input100" data-placeholder="Votre nom d'utilisateur"></span>
					</div>
					...
					<div class="wrap-input100 validate-input m-b-35" data-validate = "Champs requis">
						...
						<span class="focus-input100" data-placeholder="Confirmation du mot de passe"></span>
					</div>

					<div class="m-b-50">
						<span>Sexe</span><br><br>
						<input type="checkbox" name="sexe" value="M" id="ck1" />
						<label for="ck1">Homme</label>
						<br>
						<input type="checkbox" name="sexe" value="F" id="ck2"/>
						<label for="ck2">Femme</label>
					</div>
					...
					<ul class="login-more p-t-20">
						<li>
							<a href="//<?= Url::connect("auth");?>" class="txt2">
								Se connecter
							</a>
						</li>
					</ul>

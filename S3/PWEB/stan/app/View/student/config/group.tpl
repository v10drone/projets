	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100 p-t-85 p-b-20">
				<form class="login100-form validate-form ajax-form" data-url="//<?php echo Url::connect("ajax_set_group");?>" method="post">
					...
					<p>Il semblerait que vous ne soyez dans aucun groupe. Vous ne pouvez donc répondre à aucun test.</p><br><br>
					
					<div class="wrap-input100 validate-input m-b-35" data-validate = "Champs requis">
						<input class="input100" type="text" name="code">
						<span class="focus-input100" data-placeholder="Code du groupe"></span>
					</div>
